...
- reason: Must follow the format "Reason(scoring point X):match\"the corresponding text in the reference answer\"\nYOUR_REASON ". YOUR_REASON should be a concise explanation generated by the LLM, and the text in quotes must be an exact excerpt from the reference answer,Please strictly follow this format requirement.
